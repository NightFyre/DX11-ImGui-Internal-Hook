...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Rig_M1FlakVest_Widget.Rig_M1FlakVest_Widget_C
	 * Size -> 0x0018 (FullSize[0x02F8] - InheritedSize[0x02E0])
	 */
	class URig_M1FlakVest_Widget_C : public URigWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Rig_M1FlakVest_Widget(int32_t EntryPoint);
