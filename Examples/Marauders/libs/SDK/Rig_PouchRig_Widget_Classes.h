...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Rig_PouchRig_Widget.Rig_PouchRig_Widget_C
	 * Size -> 0x0018 (FullSize[0x02F8] - InheritedSize[0x02E0])
	 */
	class URig_PouchRig_Widget_C : public URigWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Rig_PouchRig_Widget(int32_t EntryPoint);
