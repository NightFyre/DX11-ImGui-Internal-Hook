...
namespace CG
{
	 ...
	 */
	struct UBotShootEnemy_C_ReceiveTick_Params
	{
	public:
	 ...
	 */
	struct UBotShootEnemy_C_ExecuteUbergraph_BotShootEnemy_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_FAWX[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
