...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass MM_Core_BG_EmptyLook_Widget.MM_Core_BG_EmptyLook_Widget_C
	 * Size -> 0x0036 (FullSize[0x0296] - InheritedSize[0x0260])
	 */
	class UMM_Core_BG_EmptyLook_Widget_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_MM_Core_BG_EmptyLook_Widget(int32_t EntryPoint);
