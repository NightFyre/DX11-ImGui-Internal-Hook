...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * ControlRigBlueprintGeneratedClass RaiderChar01_CtrlRig.RaiderChar01_CtrlRig_C
	 * Size -> 0x0164 (FullSize[0x07B4] - InheritedSize[0x0650])
	 */
	class URaiderChar01_CtrlRig_C : public UControlRig
	{
	public:
		...
		unsigned char                                              UnknownData_23Y1[0x2];                                   // 0x0682(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_59F9[0x2];                                   // 0x078A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
