...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * UserDefinedStruct S_ShipAttachmentCameraOffset.S_ShipAttachmentCameraOffset
	 * Size -> 0x0090
	 */
	struct FS_ShipAttachmentCameraOffset
	{
	public:
		EShipAttachmentSlot                                        WhichAttachSlot_19_17402390479E1AE25400F7843A0755E0;     // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_RYAH[0xF];                                   // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PTV6[0x8];                                   // 0x0048(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class USoundCue*                                           DetachSound_22_823B80A24DD5998DFE458C90D937C599;         // 0x0088(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	};
